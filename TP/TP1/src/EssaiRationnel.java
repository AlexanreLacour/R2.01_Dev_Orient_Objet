    ...
    public static void testSetter() {
        ...
        public class EssaiRationnel {
            ...
            public static void main(String[] args) {
                ...
                System.out.println("Nombre de tests exécutés : " + nbTests);
                System.out.println("Nombre de tests réussis : " + nbOK);
            }

            public static void testSetNumerateur() {
                System.out.println("=== Test de la Méthode setNumerateur ===");

                // Cas nominal : numérateur = 2
                Rationnel r1 = new Rationnel(3, 5);
                r1.setNumerateur(2);
                afficheResultat(r1, 2, 5);

                // Cas avec dénominateur nul : affiche message d'erreur
                Rationnel r2 = new Rationnel(7, 0);
                r2.setNumerateur(4);
                afficheResultat(r2, 0, 0);
